...
<div class="card mb-4">
    <div class="card-body">
        ...
        foreach ($form['fields']['general'] as $field_name => $field) {
            ...
            if ($field_name == 'loginname') {
                continue;
            } ?>
            <div class="mb-3 row">
                <label for="<?php echo $field->element_id ?>"
                       class="text-nowrap col-sm-2 col-form-label me-2"><?php echo ${'entry_' . $field_name}; ?></label>
...
<div class="card mb-4">
    <div class="card-body">
        ...
        <?php if (isset($form['fields']['general']['loginname'])) { ?>
            <div class="mb-3 row">
                <label for="<?php echo $field->element_id ?>"
                       class="text-nowrap col-sm-2 col-form-label me-2"><?php echo $entry_loginname; ?></label>
                <div class="col-sm-9 h-100">
                    <?php
        ...
        <div class="mb-3 row">
            <label for="<?php echo $field->element_id ?>"
                   class="text-nowrap col-sm-2 col-form-label me-2"><?php echo $entry_password; ?></label>
            <div class="col-sm-9 h-100">
                <?php
        ...
        <div class="mb-3 row">
            <label for="<?php echo $field->element_id ?>"
                   class="text-nowrap col-sm-2 col-form-label me-2"><?php echo $entry_confirm; ?></label>
            <div class="col-sm-9 h-100">
                <?php
...
<div class="card mb-4">
    <div class="card-body">
        ...
        <div class="row align-items-center">
            <label for="<?php echo $field->element_id ?>"
                   class="text-nowrap col-5 col-sm-2 col-form-label me-2"><?php echo $entry_newsletter; ?></label>
...
<div class="ps-4 p-3 col-12 d-flex flex-wrap">
    ...
    <button id="submit_button" type="submit" form="AccountFrm"
