...
class ControllerPagesDesignPageBuilder extends AController
{
    public function main()
    {
        ...
        foreach ($allPages as $page) {
            ...
            $page['url'] = $this->html->getSecureURL('design/page_builder', '&' . http_build_query($pbParams));
            if (!$page['restricted']) {
                $page['delete_url'] = $this->html->getSecureURL('design/layout/delete', '&' . http_build_query($pbParams));
            }
