...
echo $tabs;
$test_connection_url = $this->html->getSecureURL('r/extension/taxjar_integration/test');
?>
...
<div id="content" class="panel panel-default">
                    ...
                    if ($extension_info['help']['file']) {
						...
						<a class="btn btn-white tooltips"
						   ...
						   title="<?php echo $text_more_help ?>"><i
									class="fa fa-link fa-lg"></i> <?php echo $extension_info['help']['file']['text'] ?>
						</a>
                        <?php
                    }
	...
	<div class="panel-body panel-body-nopadding tab-content col-xs-12">
		...
		<div class="form-group <?php if (!empty($error[$name])) {
            ...
            <?php } ?>
			<?php if ($name==='taxjar_integration_sales_tax_calculation' && $calculate_tax==='1') { ?>
			<div class="col-sm-4"></div>
			<div class="col-sm-8"><?php echo $nexus_address; ?></div>
			<?php }?>
		</div>
		<?php if ($name==='taxjar_integration_sales_tax_calculation' && $calculate_tax==='1') { ?>
			<?php echo $fallback_rates;?>
		<?php } ?>
		<?php if ($name==='taxjar_integration_sales_tax_report' && $tax_report==='1') { ?>
			<?php echo $sync_order;?>
		<?php } ?>
